        ...
        <ul className="flex flex-wrap flex-auto justify-evenly">
            <li>
                <div class="flex items-center pl-3">
                    <input id="type-checkbox-list" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500" />
                    <label for="type-checkbox-list" class="py-2 ml-2 text-sm font-semibold">Type</label>
                </div>
            </li>
            <li>
                <div class="flex items-center pl-3">
                    <input id="location-checkbox-list" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500" />
                    <label for="location-checkbox-list" class="py-2 ml-2 text-sm font-semibold">Location</label>
                </div>
            </li>
        </ul>
      </div>
