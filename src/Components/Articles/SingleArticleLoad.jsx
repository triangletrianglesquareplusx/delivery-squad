    ...
    return (
        <div className='container mt-8 mb-8 text-center'>
            <div className='details-img'>
                <img className="block mx-auto mb-8 max-w-full" src={SingleArticle.Image} alt={SingleArticle.Title} />
            </div>
            <div className='details-info'>
                <h1 className="relative block mb-6 font-bold text-2xl md:text-4xl text-center after:block after:bg-coral after:mt-3 after:ml-auto after:mr-auto after:mb-0 after:w-20 md:after:w-28 after:h-1 md:after:h-1.5 after:rounded-md after:content-['']">{SingleArticle.Title}</h1>
