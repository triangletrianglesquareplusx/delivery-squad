...
function ReverseArticle(props) {

  return (
    <div className="container sm:h-96 max-w-5xl mb-20 mx-auto">
      <div className="flex flex-nowrap flex-col-reverse pb-10 sm:flex-row sm:mx-5 ">
        <div className="flex flex-nowrap flex-col w-1/1 sm:w-8/12 mt-5 sm:mt-0 ">
          ...
          <div className=" h-2/6 mx-5 sm:mx-0">
            <div className="flex flex-col mt-6">
              ...
              <p className="font-monteserat font-normal text-sm text-textGrey text-left leading-5">
                {props.description}
              </p>
            </div>
          </div>
