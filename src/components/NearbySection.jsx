...
function NearbySection() {
  return (
    <section className="flex flex-col items-center w-10/12 gap-10 p-3 mx-auto mb-10">
    ...
    <div className="flex flex-col gap-10 md:gap-2 md:flex-row md:justify-around">
        ...
        <InfoCard title="Hangouts"><FaVectorSquare/></InfoCard>
        <InfoCard title="Utilities"><TbBarbell/></InfoCard>
        <InfoCard title="Shopping"><RiTShirt2Fill/></InfoCard>
    </div>
    </section>
  )
}
